...
import ASG_39 from "./assignments/ASG_39.jsx";
import ASG_40 from "./assignments/ASG_40.jsx";
import ASG_41 from "./assignments/ASG_41.jsx";
import ASG_42 from "./assignments/ASG_42.jsx";
import ASG_43 from "./assignments/ASG_43.jsx";
import ASG_44 from "./assignments/ASG_44.jsx";
import ASG_45 from "./assignments/ASG_45.jsx";
import ASG_46 from "./assignments/ASG_46.jsx";
import ASG_47 from "./assignments/ASG_47.jsx";
import ASG_48 from "./assignments/ASG_48.jsx";
import ASG_49 from "./assignments/ASG_49.jsx";
import ASG_50 from "./assignments/ASG_50.jsx";
import ASG_51 from "./assignments/ASG_51.jsx";
import ASG_52 from "./assignments/ASG_52.jsx";
import ASG_53 from "./assignments/ASG_53.jsx";
import ASG_54 from "./assignments/ASG_54.jsx";
import ASG_55 from "./assignments/ASG_55.jsx";
import ASG_56 from "./assignments/ASG_56.jsx";
    ...
    <Provider store={store}>
      <HashRouter>
        <Routes>
          ...
          <Route path="/asg-39" element={<ASG_39 />} />
          <Route path="/asg-40" element={<ASG_40 />} />
          <Route path="/asg-41" element={<ASG_41 />} />
          <Route path="/asg-42" element={<ASG_42 />} />
          <Route path="/asg-43" element={<ASG_43 />} />
          <Route path="/asg-44" element={<ASG_44 />} />
          <Route path="/asg-45" element={<ASG_45 />} />
          <Route path="/asg-46" element={<ASG_46 />} />
          <Route path="/asg-47" element={<ASG_47 />} />
          <Route path="/asg-48" element={<ASG_48 />} />
          <Route path="/asg-49" element={<ASG_49 />} />
          <Route path="/asg-50" element={<ASG_50 />} />
          <Route path="/asg-51" element={<ASG_51 />} />
          <Route path="/asg-52" element={<ASG_52 />} />
          <Route path="/asg-53" element={<ASG_53 />} />
          <Route path="/asg-54" element={<ASG_54 />} />
          <Route path="/asg-55" element={<ASG_55 />} />
          <Route path="/asg-56" element={<ASG_56 />} />
        </Routes>
      </HashRouter>
    </Provider>
  </StrictMode>
